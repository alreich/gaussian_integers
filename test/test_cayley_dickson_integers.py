...
class TestZi(TestCase):
    ...
    def test_octonion(self):
        ...
        self.assertEqual(str(o0), '(10-7i-10j-2k-3L-3Li-6Lj-7Lk)')
    ...
    def test_rand_gen_higher_orders(self):
        ...
        self.assertEqual(str(o1), '(7-8i+8j+3k-9L-10Li-8Lj-4Lk)')
    ...
    def test_parse_quaternion_string(self):
        ...
        self.assertEqual(Zi.parse_quaternion_string('8.743e-37Lk'), [0, 0, 0, 0, 0, 0, 0, 8.743e-37])
